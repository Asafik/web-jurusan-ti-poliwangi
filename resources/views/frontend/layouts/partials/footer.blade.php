        ...
        <div class="row">
            <div class="col-md-12 col-lg-4 mb-4 mb-md-4 mb-sm-4 mb-lg-0">
                ...
                <ul class="list-inline social-list-default background-color social-hover-2 mt-2">
                    <li class="list-inline-item"><a class="facebook" href="https://www.facebook.com/tipoliwangi/?locale=id_ID"><i class="fab fa-facebook"></i></a>
                    </li>
                    <li class="list-inline-item"><a class="youtube" href="https://www.youtube.com/@tipoliwangitv6016"><i class="fab fa-youtube"></i></a>
                    </li>
                    <li class="list-inline-item"><a class="instagram" href="https://www.instagram.com/tipoliwangi/"><i
            ...
            <div class="col-md-12 col-lg-8">
                <div class="row mt-0">
                    <div class="col-sm-6 col-md-3 col-lg-3 mb-4 mb-sm-4 mb-md-0 mb-lg-0">
                        ...
                        <ul>
                            <li>
                                <a href="/kerjasama-industri">Kerjasama Dalam Negeri</a>
                            </li>
                            <li>
                                <a href="https://jpc.poliwangi.ac.id/">Alumni</a>
                            </li>
                            <li>
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-3 mb-4 mb-sm-4 mb-md-0 mb-lg-0">
                        ...
                        <ul>
                            <li>
                                <a href="/sambutan-kajur">Sambutan Kajur</a>
                            </li>
                            <li>
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-3 mb-4 mb-sm-4 mb-md-0 mb-lg-0">
                        ...
                        <ul>
                            <li>
                                <a href="/peta-kampus">Peta Kampus</a>
                            </li>
                            <li>
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="/ubtksnbt">UBTK-SNBT</a>
                            </li>
                            <li>
                                <a href="/mandiri">Mandiri</a>
                            </li>
                        </ul>
                    </div>
                </div>
